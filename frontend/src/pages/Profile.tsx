              ...
              <div className='w-full xl:w-[1000px] p-4 xl:flex xl:flex-row xl:justify-start overflow-auto'>
                ...
                <div>
                  ...
                  {userCondition === 'friendRequest' ?
                    <div onClick={handleClickDeleteFriendRequest} className='flex flex-row w-64 h-10 bg-green-500 rounded-lg text-white font-bold text-lg pt-[5px] pl-[12px] mt-4 hover:bg-green-700'>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 mt-1 mr-2">
                  ...
                  {userCondition === 'friend' ?
                    <div onClick={handleClickDeleteFriend} className='flex flex-row w-44 h-10 bg-red-500 rounded-lg text-white font-bold text-lg pt-[5px] pl-[12px] mt-4 hover:bg-red-700'>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 mt-1 mr-2">
                        <path fillRule="evenodd" d="M3.75 12a.75.75 0 01.75-.75h15a.75.75 0 010 1.5h-15a.75.75 0 01-.75-.75z" clipRule="evenodd" />
                      </svg>

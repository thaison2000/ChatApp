        ...
        <div>
            {edit ?
                ...
                <div className='border-2 w-[97%] m-4 relative bg-white mb-4 flex flex-row pt-4 max-h-[400px]'>
                    ...
                    <div className='absolute top-4 right-[182px]'>
                    ...
                    <div onClick={handleClickEditPost} className='absolute top-4 right-28'>
                    ...
                    <div onClick={handleClickSendPostIntoGroup} className='absolute top-4 right-[22px]'>

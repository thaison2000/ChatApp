    ...
    return (
        <div>
            {edit ?
                ...
                <div className='border-2 w-[95%] ml-4 my-4 relative bg-white mb-4 flex flex-row pt-4 max-h-[400px]'>
                    <div className='mb-4 bg-white min-h-[100px] max-h-[500px] p-4 w-[100%] z-1 border-2 ml-4 mr-1 w-[78%] overflow-auto' dangerouslySetInnerHTML={{ __html: props.draftPost.content }}>
                    </div>
